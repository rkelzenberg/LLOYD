 ...
 */
preferences {		
	input("ip", "string", title:"IP Address", description: "10.0.0.182", defaultValue: "10.0.0.182" ,required: true, displayDuringSetup: true)		
	input("port", "string", title:"Port", description: "80", defaultValue: "80" , required: true, displayDuringSetup: true)		
}
metadata {
	definition (name: "Raspberry Pi Monitor PECAN IP", namespace: "cl0udninja", author: "Janos Elohazi") {
		capability "Polling"
		capability "Refresh"
