...
metadata {
	...
	definition (name: “Edited Ecolink Doorbell Sensor”, namespace: “GNetDevelopment”, author: “SmartThings”) {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:”contact”, type: “lighting”, width: 6, height: 4, canChangeIcon: true){
			tileAttribute (“device.contact”, key: “PRIMARY_CONTROL”) {
				...
				attributeState “open”, label: “Silent”, icon: “st.Home.home30”, backgroundColor: “#C6C7CC”
			}
