...
metadata {
    ...
    definition (name: "SHM Switch 2", namespace: "erocm123", author: "Eric Maycock") {
		capability "Switch"
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"switch", type: "lighting", width: 6, height: 4, canChangeIcon: true){
			tileAttribute ("device.switch", key: "PRIMARY_CONTROL") {
                ...
                attributeState "turningOn", label: "Disarmed", action:"switch.off", icon:"st.switches.light.on", backgroundColor:"#00a0dc", nextState:"turningOff"	
			}
		}
        main "switch"
		details(["switch"])
